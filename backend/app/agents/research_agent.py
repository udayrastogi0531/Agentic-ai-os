...
RESEARCH_PROMPT = """You are a Principal Research Analyst for Uday AI OS.
...
def create_pdf_report(topic: str, content: str, sources: list[dict], file_path: Path):
    ...
    try:
        ...
        story.append(Paragraph(f"Generated by Uday AI Operating System on {datetime.now().strftime('%B %d, %Y')}", subtitle_style))
